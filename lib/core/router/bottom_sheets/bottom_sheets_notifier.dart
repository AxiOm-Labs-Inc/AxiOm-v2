...
import 'package:hiddify/features/account/widget/connect_account_sheet.dart';
...
class BottomSheetsNotifier extends _$BottomSheetsNotifier {
  ...
  Future<void> showConnectAccount() async =>
      await _show(isScrollControlled: true, child: const ConnectAccountSheet());
}
